...
if __name__ == "__main__":
  ...
  #extract_pdf_artifacts('b3073bb4-af40-431c-898b-833548a144e5')
  #res = asyncio.run(get_pdf_pages('438d639c-2203-490d-a6f7-330052d8ed4a',
  #                                'Find pages referencing the Environmental Control System (ECS)'))
  #print(res)
